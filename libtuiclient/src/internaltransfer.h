...
#ifndef _TUI_INTERNAL_TRANSFER_H_
#define _TUI_INTERNAL_TRANSFER_H_
...
namespace TransferUI {
    ...
    class InternalTransfer : public Transfer
    {
        Q_OBJECT

    public:
        InternalTransfer(ComMeegoTransferuiInterface * interface,
